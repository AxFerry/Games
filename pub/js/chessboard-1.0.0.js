...
;(function () {
  ...
  function constructor (containerElOrString, config) {
    ...
    function buildSparePiecesHTML (color) {
      ...
      /*    
         new 
        if(pieces[i] === 'bQ' && pieceBuffer.b.q !== 0 ) { html += buildPieceHTML(pieces[i], false, sparePiecesElsIds[pieces[i]])}
        if(pieces[i] === 'wQ' && pieceBuffer.w.q !== 0 ) { html += buildPieceHTML(pieces[i], false, sparePiecesElsIds[pieces[i]])}
        if(pieces[i] === 'bN' && pieceBuffer.b.n !== 0 ) { html += buildPieceHTML(pieces[i], false, sparePiecesElsIds[pieces[i]])}
        if(pieces[i] === 'wN' && pieceBuffer.w.n !== 0 ) { html += buildPieceHTML(pieces[i], false, sparePiecesElsIds[pieces[i]])}
        if(pieces[i] === 'bP' && pieceBuffer.b.p !== 0 ) { html += buildPieceHTML(pieces[i], false, sparePiecesElsIds[pieces[i]])}
        if(pieces[i] === 'wP' && pieceBuffer.w.p !== 0 ) { html += buildPieceHTML(pieces[i], false, sparePiecesElsIds[pieces[i]])}
        if(pieces[i] === 'bB' && pieceBuffer.b.b !== 0 ) { html += buildPieceHTML(pieces[i], false, sparePiecesElsIds[pieces[i]])}
        if(pieces[i] === 'wB' && pieceBuffer.w.b !== 0 ) { html += buildPieceHTML(pieces[i], false, sparePiecesElsIds[pieces[i]])}
        if(pieces[i] === 'wR' && pieceBuffer.w.r !== 0 ) { html += buildPieceHTML(pieces[i], false, sparePiecesElsIds[pieces[i]])}
        if(pieces[i] === 'bR' && pieceBuffer.b.r !== 0 ) { html += buildPieceHTML(pieces[i], false, sparePiecesElsIds[pieces[i]])}
